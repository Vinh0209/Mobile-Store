...
public class AddToCartController extends HttpServlet {
    ...
    throws ServletException, IOException {
        HashMap<Mobile,Integer> maps = (HashMap<Mobile,Integer>) request.getSession().getAttribute("cart");
        if(maps == null){
            maps = new HashMap<>();
        }
        ...
        if(maps.containsKey(mobile)){
            maps.put(mobile, quantity + maps.get(mobile));
        }
        else {
            maps.put(mobile, quantity);
        }
